...
proc QLearningNodeMode {} {
    ...
    # Reset success flag sebelum loop
    for {set i 0} {$i < $val(nn)} {incr i} {
    ...
    for {set i 0} {$i < $val(nn)} {incr i} {
        ...
        if {$action == "sleep"} {
            ...
            listenMode $i 64 ;# atau gunakan ukuran paket listen sebenarnya jika diketahui
        } elseif {$action == "transmit"} {
            activeMode $i 512 ;# contoh: asumsikan paket transmit 512 byte
